...
3. **Profile** at `config/profile.yml` + `_profile.md` — location, targets, constraints, compensation, and user-specific rules.
...
- Store user-specific rules in `_profile.md` or `config/profile.yml`, not in this mode.
