...
1. Дотримуйся словника вище для одноманітності
2. Перекладай за змістом та ідіоматично — без дослівних перекладів
3. Зберігай структурні елементи (блоки A-F, таблиці, код, інструкції для інструментів)
4. Протестуй з реальною україномовною вакансією (наприклад, з DOU.ua або Djinni.co)
