...
1. 위 용어집을 따라 문체를 일관되게 유지합니다
2. 직역이 아니라 자연스러운 한국어로 번역합니다
3. 구조 요소(블록 A-F, 표, 코드블록, 도구 지시문)는 그대로 유지합니다
4. 실제 한국어 채용 공고(원티드, 리멤버, 잡코리아, 사람인, LinkedIn KR 등)로 테스트한 뒤 PR을 보냅니다
