...
1. التزم بجدول المصطلحات المذكور أعلاه لضمان اتساق الصياغة.
2. اكتب بلغة عربية طبيعية وسلسة، وتجنب تماماً الترجمة الحرفية الجافة.
3. حافظ على العناصر الهيكلية البرمجية (الكتل A-G، الجداول، أكواد التوثيق، وأوامر الأدوات) كما هي تماماً.
4. اختبر الترجمة مع إعلان وظيفة حقيقي مكتوب بالعربية قبل تقديم طلب الدمج (PR).
