...
1. Respecte le lexique ci-dessus pour garder le ton coherent
2. Traduis de maniere idiomatique -- pas de traduction mot a mot
3. Conserve les elements structurels (Blocs A-F, tableaux, blocs de code, instructions outils) a l'identique
4. Teste avec une vraie offre francophone (Welcome to the Jungle, APEC, Indeed FR) avant de soumettre la PR
