...
import { listTemplates, resolveTemplate, validateTemplate } from '../core/cv-templates.mjs';
...
test('Chinese Minimal renders a complete mixed-language payload', () => {
  ...
  execFileSync(process.execPath, [join('core', 'build-cv-html.mjs'), input, output, TEMPLATE], { cwd: ROOT });
