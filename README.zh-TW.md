...
<p align="center">
  <em>AI 驅動的求職自動化工具 — 評估職缺、生成客製化履歷，端到端管理你的求職管道。</em><br>
  本專案是開源專案 <a href="https://github.com/santifer/career-ops">career-ops</a> 的個人 fork，原始作者為 Santiago Fernández de Valderrama。
</p>
