...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%  Core Competencies  %%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Single-column by design (ATS rule: no parallel columns) — a wrapped inline
% list, not a multicols grid, so a linear-reading-order ATS parser sees the
% items in the same order a human does.
