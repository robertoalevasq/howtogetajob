...
// Task 1 move) — kept for SCRIPT below, which spawns the sibling
// followup-seed.mjs that moved into core/ alongside this file. REPO_ROOT is
// the actual repo root one level up, where tests/fixtures/ lives.
const ROOT = dirname(fileURLToPath(import.meta.url));
const REPO_ROOT = dirname(ROOT);
const DEFAULT_CADENCE_PROFILE = join(REPO_ROOT, 'tests', 'fixtures', 'profile-default-cadence.yml');
