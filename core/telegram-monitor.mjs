...
6. Results go to \`data/tracker-additions/{num}-{company-slug}.tsv\`, never a direct edit of \`data/applications.md\`.
7. Count EVERY row you finish (evaluated, pre-screened out, or errored). At 20, stop: write the checkpoint (\`step.id\` \`"2-pipeline"\`, top-level \`lastStopReason: "batch-limit"\`, \`counters.pipelineUrlsPending\` = rows still \`- [ ]\`), \`node core/cycle-lock.mjs release\`, summarise, end the turn. Do not continue to Step 3.
