...
// the actual repo root that templates/ and config/ live under (see
// #workspace-multitenancy Task 1).
const ROOT = dirname(__dirname);
const DEFAULT_TEMPLATES_DIR = resolve(ROOT, 'templates');
const DEFAULT_PROFILE_PATH =
  process.env.CAREER_OPS_PROFILE || resolve(ROOT, 'config', 'profile.yml');
